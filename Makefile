...
OBJS = Kernel/Boot.o Kernel/KMain.o Kernel/KLib.o Kernel/FDT.o
...
CCFLAGS = -g -c -Wall -Wpedantic -ffreestanding -fno-common -nostdlib -mno-relax -fno-stack-protector -fno-omit-frame-pointer -fno-pie -no-pie -O0 -mcmodel=medany
ASFLAGS = -g
